 ...
 * @since 16.11.2021
 */
public class QuoteJava extends AbstractModelJava implements Serializable {
    ...
    public QuoteJava(final Long timestamp, final double high, final double open, final double close, final double low, final double volume) {
        super(timestamp);
        this.high = high;
        this.open = open;
        this.close = close;
    ...
    public static String getExchangeTimezome() {
        return QuoteJava.exchangeTimezome;
    }

    public static void setExchangeTimezome(final String exchangeTimezome) {
        QuoteJava.exchangeTimezome = exchangeTimezome;
    }
    ...
    public boolean equals(final Object o) {
        ...
        final QuoteJava quote = (QuoteJava) o;
