...
import static com.kishlaly.ta.analyze.BlockResultCode.STOCH_NOT_EXTRA_OVERSOLD_SCREEN_2;

/**
 * одно из двух значений %D стохастика меньше 20
 */
public class Long_ScreenTwo_Stoch_D_TwoOrOneBelowExtraLow implements ScreenTwoBlock {
    @Override
    public BlockResult check(SymbolData screen) {
        ...
        if (!oneBelowExtraLow) {
            Log.recordCode(STOCH_NOT_EXTRA_OVERSOLD_SCREEN_2, screen);
            Log.addDebugLine("Один из двух последних %D стохастика не ниже 20 на втором экране");
            return new BlockResult(screen.getLastQuote(), STOCH_NOT_EXTRA_OVERSOLD_SCREEN_2);
        }
