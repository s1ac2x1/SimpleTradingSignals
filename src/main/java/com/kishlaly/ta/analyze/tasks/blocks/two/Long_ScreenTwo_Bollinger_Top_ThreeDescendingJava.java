 ...
 */
public class Long_ScreenTwo_Bollinger_Top_ThreeDescendingJava implements ScreenTwoBlockJava {
    @Override
    public BlockResultJava check(SymbolDataJava screen) {
        ...
        if (!descending) {
            LogJava.recordCode(BOLLINGER_TOP_NOT_DESCENDING_SCREEN_2, screen);
            LogJava.addDebugLine("The upper Bollinger band does not narrow on the second screen");
