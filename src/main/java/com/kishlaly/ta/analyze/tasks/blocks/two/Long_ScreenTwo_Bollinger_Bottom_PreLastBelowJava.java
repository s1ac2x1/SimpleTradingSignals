 ...
 */
public class Long_ScreenTwo_Bollinger_Bottom_PreLastBelowJava implements ScreenTwoBlockJava {
    @Override
    public BlockResultJava check(SymbolDataJava screen) {
        ...
        boolean below = QuotesJava.isQuoteBelowBollingerBottom(quote_2, bollinger_2);
