...
public enum BlockResultCode {
    ...
    ADAPTIVE_ADX_BELOW_THRESHOLD_SCREEN_2,
    ...
    LAST_QUOTE_CLOSE_PRICE_NOT_ABOVE_EMA26_SCREEN_2,
    EMA50_NOT_OVER_EMA200_SCREEN_1,
    LAST_QUOTE_NOT_GREEN_SCREEN_1,
    LAST_QUOTE_ABOVE_EMA_SCREEN_2,
    EMA26_DOES_NOT_GROW_SCREEN_2,
    STRICT_TREND_CHECK_FAILED_SCREEN_2,
    THREE_EMA_NOT_ASCENDING_SCREEN_1,
    THREE_EMA_NOT_ASCENDING_SCREEN_2,
    LAST_EMA_NOT_ASCENDING_SCREEN_1,
    ...
    QUOTE_NOT_GREEN_SCREEN_1,
    BOLLINGER_TOP_NOT_DESCENDING_SCREEN_2,
    BOLLINGER_BOTTOM_NOT_ASCENDING_SCREEN_2;
