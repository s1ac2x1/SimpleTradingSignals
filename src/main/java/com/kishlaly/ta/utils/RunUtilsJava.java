...
import com.kishlaly.ta.analyze.tasks.blocks.groups.FirstScreen_Buy_1Java;
import com.kishlaly.ta.analyze.tasks.blocks.groups.ThreeDisplays_Buy_1Java;
import com.kishlaly.ta.analyze.tasks.blocks.groups.ThreeDisplays_Buy_2Java;
...
import com.kishlaly.ta.analyze.tasks.blocks.groups.ThreeDisplays_Buy_5Java;
import com.kishlaly.ta.analyze.tasks.blocks.groups.ThreeDisplays_Buy_6Java;
import com.kishlaly.ta.analyze.tasks.blocks.groups.ThreeDisplays_Buy_7Java;
import com.kishlaly.ta.analyze.tasks.blocks.groups.ThreeDisplays_Buy_8Java;
import com.kishlaly.ta.analyze.tasks.blocks.groups.ThreeDisplays_Buy_9Java;
import com.kishlaly.ta.analyze.tasks.blocks.groups.ThreeDisplays_Buy_Bollinger_1Java;
import com.kishlaly.ta.analyze.tasks.blocks.groups.ThreeDisplays_Buy_Bollinger_1_2Java;
import com.kishlaly.ta.analyze.tasks.blocks.groups.ThreeDisplays_Buy_Bollinger_2Java;
import com.kishlaly.ta.analyze.tasks.blocks.groups.ThreeDisplays_Buy_Bollinger_3Java;
import com.kishlaly.ta.analyze.tasks.blocks.groups.ThreeDisplays_Buy_Bollinger_4Java;
    ...
    public static void buildTasksAndStrategiesSummary_() {
        buildTasksAndStrategiesSummary(
                ...
                new ArrayList<BlocksGroupJava>() {{
                    ...
                    add(new ThreeDisplays_Buy_8Java());
                    add(new ThreeDisplays_Buy_8Java());
                    add(new ThreeDisplays_Buy_Bollinger_1Java());
                    add(new ThreeDisplays_Buy_Bollinger_1_2Java());
                    add(new ThreeDisplays_Buy_Bollinger_2Java());
                    add(new ThreeDisplays_Buy_Bollinger_3Java());
                    add(new ThreeDisplays_Buy_Bollinger_4Java());
