...
object TestingsDBO : Table<Nothing>("testings") {
    ...
    val all_positions_count = double("all_positions_count")
    val profitable_positions_count = double("profitable_positions_count")
    val loss_positions_count = double("loss_positions_count")
    val min_position_duration_seconds = double("min_position_duration_seconds")
    val average_position_duration_seconds = double("average_position_duration_seconds")
    val max_position_duration_seconds = double("max_position_duration_seconds")
